...
1. clone repository "git clone https://github.com/RomanVinichenko/portfolio.git"
...
1. Склонируйте репозиторий с помощью команды "git clone https://github.com/RomanVinichenko/portfolio.git"
